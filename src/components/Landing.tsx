...
export function Landing({ onClaim }: { onClaim: (session: any) => void }) {
  ...
  return (
    <div ref={containerRef} className="h-screen bg-neutral-950 text-white flex flex-col items-center relative overflow-x-hidden overflow-y-auto p-6 scroll-smooth">
