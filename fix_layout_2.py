...
old_wrapper_picker = """          <div className="flex-1 w-full min-h-0 flex flex-col overflow-hidden">
            <EmojiPicker
              theme={Theme.DARK}
...
old_wrapper_customize = """          <div className="flex-1 w-full min-h-0 flex flex-col overflow-hidden">
            <EmojiPicker
              theme={Theme.DARK}
              previewConfig={{ showPreview: false }}
